...
# **🥞 PancakeSwap Prediction v2 – 2022 Update 🥞**

![PancakeSwap-Logo-Big](pancake.png)


This bot wins the majority of rounds on PancakeSwap & CandleGenie based.
This bot survived the beta and is now in the full version. Feel free to contact me: saunaer.jomfruer.0o@icloud.com
## ❤️ Our thanks:
...
- Type ``cd PancakeSwapPredictionBot-2022`` (replace with your cloned/downloaded bot folder)
- Type ``npm i``
...
***saunaer.jomfruer.0o@icloud.com
